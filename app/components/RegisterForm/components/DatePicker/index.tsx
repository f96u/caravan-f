...
import { Days } from '@/app/components/RegisterForm/components/DatePicker/components/Days'
...
export const DatePicker = ({ calendarDate, onChange, className }: Props) => {
  ...
  return (
    <div className={`grid h-fit justify-items-center space-y-0.5 ${className}`}>
