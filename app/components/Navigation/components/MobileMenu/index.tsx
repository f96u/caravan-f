  ...
  return (
    <div className="absolute w-full sm:hidden">
      ...
      <div className="pointer-events-none relative">
        <div
          className={`absolute mt-1 w-full bg-gray-800 sm:hidden ${mobileMenuState.enableAnimate ? 'transition-all delay-75 ease-in ' : ' '}${mobileMenuState.show ? 'pointer-events-auto opacity-100' : `pointer-events-none opacity-0` }`}
          id="mobile-menu"
